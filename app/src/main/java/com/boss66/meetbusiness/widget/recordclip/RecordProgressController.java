package com.boss66.meetbusiness.widget.recordclip;
...
public class RecordProgressController {
    ...
    public boolean isPassMinPoint() {
        ...
        return recordedTime >= RecordVideoActivity.MIN_DURATION;
    }
    ...
    public int getRecordedTime() {
        return mProgressView.mTotalWidth * RecordVideoActivity.MAX_DURATION / mProgressView
                .mScreenWidth;
    }
