...
/**
 * Created by Johnny on 2017-08-29.
 */
public class PagerAdapter extends BaseRecycleViewAdapter {
    private int widthScreen;
    private ImageLoader imageLoader;
    private ItemClickListener clickListener;
    private Resources resources;

    public PagerAdapter(Context context, ItemClickListener listener) {
    ...
    @Override
    public void onBindItemHolder(final RecyclerView.ViewHolder viewHolder, final int position) {
        final VideoEntity entity = (VideoEntity) datas.get(position);
        if (entity != null) {
            final VideoView holder = (VideoView) viewHolder;
