 ...
 */
public class MemberFocusRequest extends BaseDataRequest<BaseMember> {

    public MemberFocusRequest(String tag, Object... params) {
        super(tag, params);
    }
    ...
    protected String getApiPath() {
        return HttpUrl.ATTENTION_LIST_FOCUS;
    }
